...
public class GameNum2 {
    ...
    private int round;
    private DoubleList deck_1 = new DoubleList();
    private DoubleList deck_2 = new DoubleList();
    ...
    public GameNum2(String name1, String name2, String data) {
        names = new String[2];
        names[0] = name1;
        names[1] = name2;
        boolean f = false;
    ...
    public void start() {
        ...
        System.out.println(names[0] + " " + names);
        System.out.println(names[1] + " " + names);
        setRound(0);
        int val1, val2, temp;
